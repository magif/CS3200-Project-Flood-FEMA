/*
 HEY HEY HEY, this is actually really slow to run b/c the real data 5gb is large and dirty
 I Made another file -- [group13_backup_SAMPLE_DATA.sql]
 which has insert into made from the query below for each table

 select * from [table] ORDER BY RAND(1) LIMIT 1000;


 this one literally uses staging b/c how the original data is structured is a mess for fima_nfip_claims from [FimaNfipClaimsV2.csv]
