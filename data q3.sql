...
WITH ClaimAgg AS (
    ...
    SELECT
        ...
        SUM(((GREATEST(IFNULL(c.amountPaidOnBuildingClaim, 0), 0) +
              GREATEST(IFNULL(c.amountPaidOnContentsClaim, 0), 0)) / c.buildingPropertyValue) * 100) AS sum_pct_destroyed
...
ArchetypeData AS (
    SELECT
        ...
        CASE
            ...
            WHEN PROP_DEV_LOWINTENSITY + PROP_DEV_MEDINTENSITY + PROP_DEV_HIINTENSITY >= 0.5 THEN '2. Suburban Sprawl'
...
-- =======================================================================================
-- QUERY 3: Inflation-Adjusted Macro Trends with Cross-Join Optimization
-- =======================================================================================
